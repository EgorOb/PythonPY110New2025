...
> Что делает: Прерывает запрос, если сервер не ответил за N миллисекунд.
> 
> Применение:
> * Уменьшение ожидания
> * Обработка "плохого" соединения
...
| Удаление с подтверждением      | hx-confirm, hx-disable   |
...
| Загрузка с тайм-аутом          | hx-timeout               |
