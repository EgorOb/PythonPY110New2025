...
<h2>1. input — поиск при вводе</h2>
  ...
  <input placeholder="Попробуй скопировать"
         hx-get="/htmx/hx-trigger/input/clipboard-event/"
         hx-trigger="copy"
         hx-vals='{"action": "copy"}'
         hx-target="#clipboard-result">

  <input placeholder="Попробуй вырезать"
         hx-get="/htmx/hx-trigger/input/clipboard-event/"
         hx-trigger="cut"
         hx-vals='{"action": "cut"}'
         hx-target="#clipboard-result">

  <input placeholder="Попробуй вставить"
         hx-get="/htmx/hx-trigger/input/clipboard-event/"
         hx-trigger="paste"
...
Можешь привести примеры использования drag-and-drop в интерфейсе?
