...
Зафиксируем изменения (если хотите можете добавить файл базы данных db.sqlite3 в систему контроля версий) сделав коммит и отправим эти коммиты на github